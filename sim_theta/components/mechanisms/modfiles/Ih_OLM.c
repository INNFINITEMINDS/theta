...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 IhOLM C:/Users/Tyler/Desktop/git_stage/theta/sim_theta/components/mechanisms/modfiles/Ih_OLM.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "Ih_OLM.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "\n"
