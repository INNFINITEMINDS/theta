...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
 	...
 	ivoc_help("help ?1 lcaBC C:/Users/Tyler/Desktop/git_stage/theta/sim_theta/components/mechanisms/modfiles/Lca_BC.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "Lca_BC.mod";
static const char* nmodl_file_text = 
