...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 lca C:/Users/Tyler/Desktop/git_stage/theta/sim_theta/components/mechanisms/modfiles/cell_lca.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "cell_lca.mod";
static const char* nmodl_file_text = 
