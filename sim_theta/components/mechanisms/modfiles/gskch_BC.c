...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "tca_ion");
 	...
 	ivoc_help("help ?1 gskchBC C:/Users/Tyler/Desktop/git_stage/theta/sim_theta/components/mechanisms/modfiles/gskch_BC.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "gskch_BC.mod";
static const char* nmodl_file_text = 
