...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 8, "ks_ion");
 	...
 	ivoc_help("help ?1 ichan2OLM C:/Users/Tyler/Desktop/git_stage/theta/sim_theta/components/mechanisms/modfiles/ichan2_OLM.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "ichan2_OLM.mod";
static const char* nmodl_file_text = 
  "TITLE ichan2.mod  \n"
  " \n"
  "COMMENT\n"
