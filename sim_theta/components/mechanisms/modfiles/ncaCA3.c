...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "nca_ion");
 	...
 	ivoc_help("help ?1 ncaCA3 C:/Users/Tyler/Desktop/git_stage/theta/sim_theta/components/mechanisms/modfiles/ncaCA3.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "ncaCA3.mod";
static const char* nmodl_file_text = 
  "TITLE nca.mod  \n"
  "  \n"
  "COMMENT\n"
